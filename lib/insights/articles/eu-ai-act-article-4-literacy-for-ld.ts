...
export const article: InsightArticle = {
  ...
  title: "EU AI Act Article 4: what L&D actually has to do",
  description:
...
If you need a conversation about scope, dates, and what the record should contain, [contact Experrt](/contact). Bring the list of roles and the tools they already use. That is enough to start.
`,
};
