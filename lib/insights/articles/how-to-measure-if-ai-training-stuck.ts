...
export const article: InsightArticle = {
  ...
  title: "How to measure whether AI training actually stuck",
  description:
...
**1. A before-and-after work sample.** Same type of task: a draft, a summary, a check-list. Score it against a written standard (sources, numbers, policy, refusal). Do this on five or ten pieces, not a census. [Embedding AI in Daily Workflows](/courses/embedding-ai-in-daily-workflows) already uses the job as the unit of practice. Reuse that artefact.

**2. A checking behaviour you can count.** For example: proportion of AI-assisted drafts that include a named check, or a record that a person reviewed the output. [AI output verification at work](/insights/ai-output-verification-at-work) is the briefing for that standard. You are measuring whether the standard is in use, not whether people enjoyed hearing about it.

**3. Manager observation.** A one-line note in the month after the cohort: is the team refusing bad outputs, or still shipping fluent errors? That is why [Managers, not champions, after you buy the tools](/insights/managers-not-champions-ai-adoption) sits next to this one. If the manager was not trained, your measure will be noise.

**4. The training record itself.** Attendance, the assessed task, the grade or observed outcome, the export. [AI Governance and Oversight for Managers](/courses/ai-governance-and-oversight-for-managers) is where sponsors learn what they will be asked to show. A missing register means you cannot even say who was in the room.
