...
export const metadata: Metadata = withSiteShareImages({
  ...
  description:
    "Courses your people can take in their own time across AI, technology, robotics, and HR. Prompt Engineering for Professional Work can be taken now. The other courses are listed and are not available to purchase yet.",
