...
export default function PrivacyPage() {
  return (
    <article className="prose prose-neutral dark:prose-invert max-w-none">
      ...
      <p>If you finish a course you may leave a review. We publish your rating, your words, an optional job title and either your first name and initial or your full name, as you choose, with a Verified learner label. You can edit or remove your review at any time, and it is deleted if you close your account. We may hide a review that breaks the law or our course terms, but we do not edit reviews or pay for them.</p>
      <p>If you buy places on a course for other people, we store the names and email addresses you give us for those people and send each of them an invitation. We use them only to give them access to the course. The buyer can see whether each person has accepted, how many lessons they have passed and whether they have finished, but not their answers.</p>
